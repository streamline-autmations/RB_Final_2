...
import HuntingPufferJacketPage from './pages/products/HuntingPufferJacketPage';
import TabSocksPage from './pages/products/TabSocksPage';
import AnkleSocksPage from './pages/products/AnkleSocksPage';
      ...
      <main>
        <AnimatePresence mode="wait">
          <Routes>
            ...
            <Route path="/products/matric-jacket" element={<MatricJacketPage />} />
            ...
            <Route path="/products/hunting-puffer-jacket" element={<HuntingPufferJacketPage />} />
            <Route path="/products/tab-socks" element={<TabSocksPage />} />
            <Route path="/products/ankle-socks" element={<AnkleSocksPage />} />
            ...
            {/* Hunting */}
            <Route path="/products/hunting-zip-top" element={<GenericProductPage />} />
            <Route path="/products/hunting-puffer-short" element={<GenericProductPage />} />
            <Route path="/products/hunting-puffer-long" element={<GenericProductPage />} />
            <Route path="/products/hunting-hoodie" element={<GenericProductPage />} />
            <Route path="/products/hunting-softshell" element={<GenericProductPage />} />
            
            {/* Schoolwear */}
            <Route path="/products/school-hoodie" element={<GenericProductPage />} />
            <Route path="/products/school-tracksuit-pants" element={<GenericProductPage />} />
            <Route path="/products/school-tshirt-short" element={<GenericProductPage />} />
            <Route path="/products/school-tshirt-long" element={<GenericProductPage />} />
            <Route path="/products/school-golfer-short" element={<GenericProductPage />} />
            <Route path="/products/school-golfer-long" element={<GenericProductPage />} />
            <Route path="/products/school-skirts" element={<GenericProductPage />} />
            <Route path="/products/school-softshell" element={<GenericProductPage />} />
            <Route path="/products/school-puffer" element={<GenericProductPage />} />
            
            {/* Corporate */}
            <Route path="/products/corporate-softshell" element={<GenericProductPage />} />
            <Route path="/products/corporate-zip-top" element={<GenericProductPage />} />
            <Route path="/products/corporate-puffer-short" element={<GenericProductPage />} />
            <Route path="/products/corporate-puffer-long" element={<GenericProductPage />} />
            
            {/* Gym */}
            <Route path="/products/gym-crop-top" element={<GenericProductPage />} />
            <Route path="/products/gym-hoodie" element={<GenericProductPage />} />
            <Route path="/products/gym-tracksuit-pants" element={<GenericProductPage />} />
            <Route path="/products/gym-tshirt-long" element={<GenericProductPage />} />
            
            {/* Accessories */}
            <Route path="/products/leg-sleeves" element={<GenericProductPage />} />
            <Route path="/products/uv-arm-sleeves" element={<GenericProductPage />} />
            <Route path="/products/sweatbands" element={<GenericProductPage />} />
            <Route path="/products/visor-cap" element={<GenericProductPage />} />
            <Route path="/products/cap" element={<GenericProductPage />} />
            <Route path="/products/backpack" element={<GenericProductPage />} />
