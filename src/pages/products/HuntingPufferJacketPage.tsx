...
const HuntingPufferJacketPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hunting-puffer-jacket-frontback.png', alt: 'Hunting Puffer Jacket Front and Back View' },
    { src: '/hunting-puffer-jacket-design-guide.png', alt: 'Hunting Puffer Jacket Design Guide' },
    { src: '/hunting-puffer-jacket-design-guide-back.png', alt: 'Hunting Puffer Jacket Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hunting-puffer-jacket-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HUNTING PUFFER JACKET</h1>
            <p className="text-xl text-rb-gray-300">Built for the wild - premium insulation meets rugged durability</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• Premium insulation for extreme weather conditions</li>
                  <li>• Water-resistant and windproof outer shell</li>
                  <li>• Reinforced construction for rugged outdoor use</li>
                  <li>• Multiple pockets for hunting essentials</li>
                  <li>• Easy to clean and maintain in harsh conditions</li>
                </ul>
              </motion.div>
...
export default HuntingPufferJacketPage;