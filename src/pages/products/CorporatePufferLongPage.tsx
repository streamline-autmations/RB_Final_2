...
const CorporatePufferLongPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/corporate-puffer-long-frontback.png', alt: 'Corporate Puffer Long Front and Back View' },
    { src: '/corporate-puffer-long-design-guide.png', alt: 'Corporate Puffer Long Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/corporate-puffer-long-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CORPORATE PUFFER LONG</h1>
            <p className="text-xl text-rb-gray-300">Professional long puffer jacket designed for corporate environments</p>
          </motion.div>
        </div>
      </section>
...
export default CorporatePufferLongPage;