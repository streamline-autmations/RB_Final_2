    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/leggings-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">LEGGINGS</h1>
            <p className="text-xl text-rb-gray-300">High-performance leggings designed for flexibility and comfort</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  ...
                  <li>• Compression fit for muscle support and recovery</li>
                  <li>• Moisture-wicking technology for dry comfort</li>
                  <li>• Flattering fit that maintains shape during activity</li>
                  <li>• Easy care and quick-drying materials</li>
                </ul>
              </motion.div>
