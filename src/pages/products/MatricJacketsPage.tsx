    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/matric-jackets-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl text-rb-gray-300">Premium matric jackets to celebrate your graduation milestone</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/matric-jackets-frontback.png"
                alt="Matric Jackets"
                className="w-full h-full object-cover"
                onError={(e) => {
                  e.currentTarget.src = 'https://images.pexels.com/photos/6311475/pexels-photo-6311475.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2';
                }}
              />
            </motion.div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• Premium quality matric jackets for graduation celebrations</li>
                  <li>• Custom embroidery with school name, year, and student details</li>
                  <li>• Available in multiple styles and color combinations</li>
                  <li>• Durable construction for lasting memories</li>
                  <li>• Professional finishing and attention to detail</li>
                  <li>• Bulk ordering available for entire matric classes</li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <Button to="/catalogues/matric" variant="outline" size="lg" className="w-full">
                  VIEW MATRIC CATALOGUE
                </Button>
              </motion.div>
            </div>
          </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Tracksuits',
                image: '/tracksuits-frontback.png',
