...
const DartsShirtsPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/darts-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">DARTS SHIRTS</h1>
            <p className="text-xl text-rb-gray-300">Professional darts shirts designed for precision and comfort</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/darts-shirt-frontback.png"
                alt="Darts Shirts"
                className="w-full h-full object-cover"
                onError={(e) => {
                  e.currentTarget.src = 'https://images.pexels.com/photos/4753878/pexels-photo-4753878.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2';
                }}
              />
            </motion.div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• Lightweight, breathable fabric for comfort during play</li>
                  <li>• Moisture-wicking technology to keep you dry</li>
                  <li>• Professional appearance for tournaments and leagues</li>
...
export default DartsShirtsPage;