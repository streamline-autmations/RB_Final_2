...
const HockeyTShirtLongPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/long-sleeve-t-shirt-frontback.png', alt: 'Hockey Long Sleeve T-Shirt Front and Back View' },
    { src: '/long-sleeve-t-shirt-design-guide.png', alt: 'Hockey Long Sleeve T-Shirt Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/long-sleeve-t-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HOCKEY LONG SLEEVE T-SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage hockey t-shirt for training and cooler conditions</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Hockey Short Sleeve T-Shirt',
...
export default HockeyTShirtLongPage;