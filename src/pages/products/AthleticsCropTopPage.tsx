...
const AthleticsCropTopPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">ATHLETICS CROP TOP</h1>
            <p className="text-xl text-rb-gray-300">Performance crop top designed for female athletes</p>
          </motion.div>
        </div>
      </section>
...
export default AthleticsCropTopPage;