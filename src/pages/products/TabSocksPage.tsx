    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/tab-socks.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">TAB SOCKS</h1>
            <p className="text-xl text-rb-gray-300">Premium tab socks for athletic performance</p>
          </motion.div>
        </div>
      </section>
                  ...
                  <table className="w-full text-rb-gray-300">
                    <tbody className="space-y-2">
                      ...
                      <tr>
                        ...
                        <td className="py-2">2cm above shoe</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
