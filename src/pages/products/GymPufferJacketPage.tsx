    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/puffer-jacket-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GYM PUFFER JACKET</h1>
            <p className="text-xl text-rb-gray-300">Insulated puffer jacket designed for pre and post-workout warmth</p>
          </motion.div>
        </div>
      </section>
...
export default GymPufferJacketPage;