...
const AthleticsMensVestPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/athletics-mens-vest-frontback.png', alt: 'Athletics Mens Vest Front and Back View' },
    { src: '/athletics-mens-vest-design-guide.png', alt: 'Athletics Mens Vest Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/athletics-mens-vest-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">ATHLETICS MENS VEST</h1>
            <p className="text-xl text-rb-gray-300">Performance vest designed for male athletics athletes</p>
          </motion.div>
        </div>
      </section>
...
export default AthleticsMensVestPage;