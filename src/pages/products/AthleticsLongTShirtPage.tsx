...
const AthleticsLongTShirtPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/athletics-long-sleeve-t-shirt-frontback.png', alt: 'Athletics Long Sleeve T-Shirt Front and Back View' },
    { src: '/athletics-long-sleeve-t-shirt-design-guide.png', alt: 'Athletics Long Sleeve T-Shirt Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/athletics-long-sleeve-t-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">ATHLETICS LONG SLEEVE T-SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage athletics t-shirt for training and competition</p>
          </motion.div>
        </div>
      </section>
...
export default AthleticsLongTShirtPage;