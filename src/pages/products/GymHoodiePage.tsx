    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hoodie-gym-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GYM HOODIE</h1>
            <p className="text-xl text-rb-gray-300">Performance hoodie designed for training and casual gym wear</p>
          </motion.div>
        </div>
      </section>
