...
const AthleticsLeggingsPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/athletics-leggings-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">ATHLETICS LEGGINGS</h1>
            <p className="text-xl text-rb-gray-300">High-performance leggings designed for athletics and training</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/athletics-leggings-frontback.png"
                alt="Athletics Leggings"
...
export default AthleticsLeggingsPage;