...
const CorporateSoftshellPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/corporate-softshell-frontback.png', alt: 'Corporate Softshell Jacket Front and Back View' },
    { src: '/corporate-softshell-design-guide.png', alt: 'Corporate Softshell Jacket Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/corporate-softshell-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CORPORATE SOFTSHELL JACKET</h1>
            <p className="text-xl text-rb-gray-300">Professional softshell jacket designed for corporate environments</p>
          </motion.div>
        </div>
      </section>
...
export default CorporateSoftshellPage;