...
const CorporateShirtPage: React.FC = () => {
  ...
  const images = [
    { src: '/corporate-shirt-frontback.png', alt: 'Corporate Shirt Front and Back View' },
    { src: '/corporate-shirt-design-guide.png', alt: 'Corporate Shirt Design Guide' },
    { src: '/corporate-shirt-design-guide-back.png', alt: 'Corporate Shirt Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/corporate-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CORPORATE SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Professional corporate shirts designed for business excellence</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  ...
                  <li>• Wrinkle-resistant fabric for all-day wear</li>
                  <li>• Breathable materials for workplace comfort</li>
                  <li>• Durable construction for frequent use</li>
