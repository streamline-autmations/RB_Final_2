...
const GolfShirtPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/golf-shirt-frontback.png', alt: 'Golf Shirt Front and Back View' },
    { src: '/golf-shirt-design-guide.png', alt: 'Golf Shirt Design Guide' },
    { src: '/golf-shirt-design-guide-back.png', alt: 'Golf Shirt Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/golf-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GOLF SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Premium golf shirts designed for style and performance on the course</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• Premium golf performance fabric with UV protection</li>
                  <li>• Moisture-wicking technology for all-day comfort</li>
                  <li>• Four-way stretch for unrestricted swing motion</li>
                  <li>• Professional appearance on and off the course</li>
                  <li>• Easy care and wrinkle-resistant finish</li>
                </ul>
              </motion.div>
