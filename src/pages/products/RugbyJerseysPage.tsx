    ...
    <>
      ...
      <section className="pt-24 md:pt-32 pb-12 md:pb-16 bg-rb-black relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 px-4 md:px-8 lg:px-16">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bebas mb-4 md:mb-6">RUGBY JERSEYS</h1>
            <p className="text-lg md:text-xl text-rb-gray-300">Professional-grade rugby jerseys designed for ultimate performance and durability</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="flex gap-4">
                {/* Thumbnails */}
                <div className="flex flex-col gap-2 w-16 max-w-[60px]">
                ...
                <div className="flex-1">
                  <div className="relative aspect-square rounded-lg overflow-hidden bg-rb-gray-800 w-full max-w-[320px] mx-auto lg:max-w-none">
                    <img
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Rugby Warm-Up Short Sleeve',
                image: '/rugby-warmup-short.png',
