...
const GymShirtPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/gym-shirt-frontback.png', alt: 'Gym Shirt Front and Back View' },
    { src: '/gym-shirt-design-guide.png', alt: 'Gym Shirt Design Guide' },
    { src: '/gym-shirt-design-guide-back.png', alt: 'Gym Shirt Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/gym-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GYM SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Engineered for peak performance - built to push your limits</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• High-performance design for intense gym sessions</li>
                  <li>• Advanced moisture-wicking and quick-dry technology</li>
                  <li>• Four-way stretch fabric for unrestricted movement</li>
                  <li>• Anti-odor treatment for extended freshness</li>
                  <li>• Easy to clean and built for daily training</li>
                </ul>
              </motion.div>
