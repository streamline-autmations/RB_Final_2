...
const HockeyLadiesVestPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/hockey-ladies-vest-frontback.png', alt: 'Hockey Ladies Vest Front and Back View' },
    { src: '/hockey-ladies-vest-design-guide.png', alt: 'Hockey Ladies Vest Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/hockey-ladies-vest-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">HOCKEY LADIES VEST</h1>
            <p className="text-xl text-rb-gray-300">Performance vest designed specifically for female hockey athletes</p>
          </motion.div>
        </div>
      </section>
...
export default HockeyLadiesVestPage;