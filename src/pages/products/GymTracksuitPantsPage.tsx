...
const GymTracksuitPantsPage: React.FC = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/tracksuit-pants-gym-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">GYM TRACKSUIT PANTS</h1>
            <p className="text-xl text-rb-gray-300">Performance tracksuit pants designed for training and casual gym wear</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <img
                src="/tracksuit-pants-gym-frontback.png"
                alt="Gym Tracksuit Pants"
...
export default GymTracksuitPantsPage;