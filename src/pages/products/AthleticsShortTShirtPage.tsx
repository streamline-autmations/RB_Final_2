...
const AthleticsShortTShirtPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/athletics-short-sleeve-t-shirt-frontback.png', alt: 'Athletics Short Sleeve T-Shirt Front and Back View' },
    { src: '/athletics-short-sleeve-t-shirt-design-guide.png', alt: 'Athletics Short Sleeve T-Shirt Design Guide' },
    { src: '/athletics-short-sleeve-t-shirt-design-guide-back.png', alt: 'Athletics Short Sleeve T-Shirt Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/athletics-short-sleeve-t-shirt-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">ATHLETICS SHORT SLEEVE T-SHIRT</h1>
            <p className="text-xl text-rb-gray-300">Lightweight athletics t-shirt designed for track and field performance</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-rb-gray-900">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Athletics Long Sleeve T-Shirt',
...
export default AthleticsShortTShirtPage;