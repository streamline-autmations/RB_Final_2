...
const MatricJacketPage: React.FC = () => {
  ...
  const images = [
    { src: '/matric-jacket-frontback.png', alt: 'Matric Jacket Front and Back View' },
    { src: '/matric-jacket-design-guide.png', alt: 'Matric Jacket Design Guide' },
    { src: '/matric-jacket-design-guide-back.png', alt: 'Matric Jacket Design Guide Back' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/matric-jacket-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">MATRIC JACKET</h1>
            <p className="text-xl text-rb-gray-300">Celebrate your achievement in style - premium matric jackets for life's milestone moments</p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• Premium materials designed for lasting memories</li>
                  <li>• Weather-resistant fabric for year-round wear</li>
                  <li>• Durable construction to withstand daily use</li>
                  <li>• Comfortable fit with classic styling</li>
                  <li>• Easy to clean and maintain for years to come</li>
                </ul>
              </motion.div>
