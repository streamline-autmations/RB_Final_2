...
const CorporatePufferShortPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/corporate-puffer-short-frontback.png', alt: 'Corporate Puffer Short Front and Back View' },
    { src: '/corporate-puffer-short-design-guide.png', alt: 'Corporate Puffer Short Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/corporate-puffer-short-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CORPORATE PUFFER SHORT</h1>
            <p className="text-xl text-rb-gray-300">Professional short puffer jacket designed for corporate environments</p>
          </motion.div>
        </div>
      </section>
...
export default CorporatePufferShortPage;