...
const CricketLongGolferPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/long-sleeve-golfer-frontback.png', alt: 'Cricket Long Sleeve Golfer Front and Back View' },
    { src: '/long-sleeve-golfer-design-guide.png', alt: 'Cricket Long Sleeve Golfer Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/long-sleeve-golfer-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CRICKET LONG SLEEVE GOLFER</h1>
            <p className="text-xl text-rb-gray-300">Extended coverage cricket wear for all-day comfort and sun protection</p>
          </motion.div>
        </div>
      </section>
...
export default CricketLongGolferPage;