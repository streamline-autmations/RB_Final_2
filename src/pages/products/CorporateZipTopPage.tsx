...
const CorporateZipTopPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  
  const images = [
    { src: '/corporate-zip-top-frontback.png', alt: 'Corporate Zip Top Front and Back View' },
    { src: '/corporate-zip-top-design-guide.png', alt: 'Corporate Zip Top Design Guide' }
  ];
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(/corporate-zip-top-frontback.png)` }}
        />
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">CORPORATE ZIP TOP</h1>
            <p className="text-xl text-rb-gray-300">Professional zip top designed for corporate environments</p>
          </motion.div>
        </div>
      </section>
...
export default CorporateZipTopPage;