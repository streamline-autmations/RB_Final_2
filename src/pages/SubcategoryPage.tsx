...
import { getProductsBySubcategory, getAllSubcategories } from '../data/productsData';
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black texture-overlay relative">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">{subcategoryName} Products</h1>
