      ...
      children: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Tracksuits & Hoodies', path: '/products/tracksuits-hoodies' },
            { label: 'T-Shirts & Golfers', path: '/products/tshirts-golfers' },
            { label: 'Jackets', path: '/products/school-jackets' },
            { label: 'Female Apparel', path: '/products/female-apparel' },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Socks', path: '/products/socks' },
            { label: 'Headwear', path: '/products/headwear' },
            { label: 'Bags', path: '/products/bags' },
            { label: 'Warmup & Training', path: '/products/warmup-training' },
          ],
        },
      ],
    },
